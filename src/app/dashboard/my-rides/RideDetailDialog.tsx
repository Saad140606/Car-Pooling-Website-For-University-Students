...
export function RideDetailDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 border-slate-700">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-white">Ride Details</DialogTitle>
        ...
        <div className="space-y-4 mt-2">
          <div className="flex items-center justify-between">
            <Badge className="bg-slate-800/70 text-slate-200 border border-slate-600 capitalize">
              {ride.status || 'active'}
            </Badge>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-center gap-2 p-3 rounded-xl bg-gradient-to-br from-emerald-900/30 to-emerald-950/50 border border-emerald-700/30">
            ...
            <div className="flex items-center gap-2 p-3 rounded-xl bg-gradient-to-br from-purple-900/30 to-purple-950/50 border border-purple-700/30">
          ...
          {/* Passengers - Compact */}
          <div className="flex items-center gap-2 p-3 rounded-xl bg-gradient-to-br from-blue-900/20 to-blue-950/40 border border-blue-700/30">
