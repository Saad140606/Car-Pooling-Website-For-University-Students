...
export interface PendingRating {
  ...
  to: string;
  departureTime: Date;
  rideCompletedAt: Date;         // departureTime + completion window
...
export interface RideCompletionStatus {
  ...
  isCompleted: boolean;
  departureTime: Date;
  completedAt: Date | null;      // departureTime + completion window
  ratingEligibleAt: Date | null; // departureTime + completion window
...
/**
 * Calculate if a ride is completed (completion window after departure)
 */
...
/**
 * Calculate if rating is eligible (completion window after departure)
 */
